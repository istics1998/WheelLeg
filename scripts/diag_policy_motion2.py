...
# 强制指令序列: (vx, vy, wz, 标签)
# ⚠ 测试点必须在训练指令分布内(见 env_cfg ranges + curriculum),否则测的是策略外推,不可信。
# 当前训练范围:lin_vel_x ±0.3(物理上限~0.36),ang_vel_z 初始±1.5→curriculum末±3.0。
PHASES = [
    (0.3, 0.0, 0.0, "前进 vx=+0.3"),
    (-0.3, 0.0, 0.0, "后退 vx=-0.3"),
    (0.0, 0.0, 1.5, "左转 wz=+1.5"),
    (0.0, 0.0, -1.5, "右转 wz=-1.5"),
    (0.0, 0.0, 3.0, "快左转 wz=+3.0"),
    (0.0, 0.0, -3.0, "快右转 wz=-3.0"),
    (0.0, 0.0, 0.0, "停 全0"),
]
